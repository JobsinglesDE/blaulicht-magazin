...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, url: `${BASE_URL}/regional/sanitaet`, type: 'website', siteName: 'Blaulicht Magazin', locale: 'de_CH', images: [{ url: `${BASE_URL}/logos/jobsingles-logo.webp`, alt: title }] },
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <Breadcrumbs items={[
          ...
          { label: 'Sanität', href: '/regional/sanitaet' },
        ]} />
