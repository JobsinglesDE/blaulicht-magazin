...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, url: `${BASE_URL}/regional/feuerwehr`, type: 'website', siteName: 'Blaulicht Magazin', locale: 'de_CH', images: [{ url: `${BASE_URL}/logos/jobsingles-logo.webp`, alt: title }] },
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <h2 className="sr-only">Feuerwehr-Singles nach Kanton</h2>
      ...
      <PillarLongIntro beruf="feuerwehr" />
    </>
  );
}
